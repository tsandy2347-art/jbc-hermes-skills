"""Read-only Xero OAuth2 client_credentials helper for jbc-tax-compliance.

Mirrors the jbc-reconciliation client but adds journal-pagination by date
window and Trial-Balance row-by-account lookup needed by the tax detectors.
